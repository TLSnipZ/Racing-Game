...
export function createNewGameState(): GameState {
  return { cashYen: STARTING_CASH_YEN, playerLevel: 1, reputation: 0, selectedStarterId: null,
    ownedVehicles: [], activeVehicleId: null, economy: createEconomyState(), racing: createRacingState(), market: createMarketState(), heat: createHeatState(), collection: createEmptyCollectionState() };
}
...
export const purchaseStarter = withCollectionProgress(function purchaseStarter(state: GameState, starterId: string, instanceId: string): GameState {
