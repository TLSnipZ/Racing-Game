...
export function SaveManagement({ game, blocked, onImport, onReset }: {
  ...
  return <section id="save-data" className="savePanel phase3SavePanel" aria-label="Save management">
    ...
    <div className="saveGrid">
      <article><div className="saveIcon"><Download /></div><h4>Export save</h4><p>Back up collection history, claimed rewards, Icon offers, Heat, patrol alerts, cooldowns, cars, market stock, tuning, progress, race records and your pending activity, or move your save to another device.</p>
