...
export function SaveManagement({ game, blocked, onImport, onReset }: {
  ...
  function reset() {
    if (!window.confirm('Reset your entire KAGEHAMA save?\n\nCars, parts, money, progress and any pending job will be reset. This cannot be undone unless you exported a save code first.')) return;
  ...
  return <section id="save-data" className="savePanel phase3SavePanel" aria-label="Save management">
    ...
    <div className="saveGrid">
      <article><div className="saveIcon"><Download /></div><h4>Export save</h4><p>Back up cars, tuning, progress and your pending job, or move your save to another device.</p>
