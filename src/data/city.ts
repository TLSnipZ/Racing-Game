...
export const CITY_DISTRICTS: readonly DistrictDefinition[] = [
  ...
  { id: 'industrial', name: 'Industrial District', number: '05', scene: 'BUSINESSES / STAFF', minLevel: 3,
    future: null,
    description: 'Detailing bays, parts dispatch and dyno bookings. Buy your first business, hire its manager and make room for more cars.', services: [] },
